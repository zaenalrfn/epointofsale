...
<body>
	...
	<div class="pemesanan">
		<div class="container">
			<div class="row">
				<h1 class="mt-5 mb-5">Pemesanan</h1>
				<div class="col-lg-5" style="background-color: #DCDCDC;">
					<div class="thumbnail-pemesanan">
				...
				<div class="col-lg-5">
					...
					<h1>title</h1>
					<p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, aperiam. Expedita ab assumenda, quod ipsum! Nemo consequatur, perferendis vel maiores labore, quidem a dolores delectus quaerat minus. Fuga, officia. Consequuntur?</p>
					<h3>$100</h3>
					<a href="transaksi.php" class="btn">Order</a>
				</div>
			</div>
		</div>
	</div>
